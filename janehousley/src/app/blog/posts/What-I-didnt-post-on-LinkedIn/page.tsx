...
export default function What_I_didnt_post() {
    return (
        <BlogPostLayout title="What I didn't post on LinkedIn" subtitle="Ain't no growth in the comfort zone, baby!" date="26 February 2025">
            ...
            <p className="italic">
                @quot;This August, I'll be moving to Madison, Wisconsin to work full time as a software developer at Epic! 
            ...
            <p>
                ...
                kiss Utah's dirt, and proclaim to her how much I'll miss her. I imagine she says, @quot;I'm not going anywhere, 
            ...
            <p>
                ...
                shoulders and say, @quot;Oh, come on. You're not going to <em>war</em>.@quot; I'm not. I'm going to Madison, Wisconsin. 
