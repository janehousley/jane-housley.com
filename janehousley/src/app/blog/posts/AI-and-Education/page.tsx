...
export default function AI_and_Education() {
    return (
        <BlogPostLayout title="AI and Education" subtitle="What is the appropriate role of AI in the classroom? How do we prevent students from becoming ChatGPT-regurgitating zombies?" date="22 May 2025">
            ...
            <h3>"AI" is the wrong word.</h3>

            <p>
                Before I divulge my thoughts, I want to set some things straight. As a math/computer science person, perhaps 
                I'm more picky about this than I need to be, but fostering intelligent conversation about this nuanced 
                topic requires defining what we're even talking about. <strong>AI is not new</strong>, at least not within 
            ...
            <h3>The two extremes and why they don't work</h3>

            <p>
                Now let's talk. The people are worried. What are we supposed to do about AI in schools? 
                ...
                has rewritten all of his curriculum in a magical way that ensures learning with the use of AI, it's 
            ...
            <p>
                ...
                is not equipped to deal with the sudden accessibility of all the world's knowledge freely and immediately 
                available. In my undergrad and master's programs, most of my professors banned the use of AI in completing 
                ...
                but AI has inflated this problem greatly to a point where educators don't know how to respond. Like 
                Prohibition in America, in the 1920's, prohibiting a behavior does not necessarily eliminate it. In 
            ...
            <h3>We're right between the past and the future</h3>
            ...
            <p>
                ...
                I don't have concrete answers, and I can't prescribe a fix-all answer. What I do know is we are in a gray area.
            </p>

            <p>
                <strong>The Past.</strong> Before these huge LLM's became publicly and freely available, academic 
            ...
            <p>
                ...
                the learning process as opposed to exactness and final products. I don't know exactly what education 
            ...
            <p>
                ...
                the education of this decade's students. Like I said, I don't have all the answers, but let's discuss 
            ...
            <p>
                Simply put, I've used AI on assignments that I don't feel necessary to complete on my own. When I don't 
                feel it's necessary to my education or to my learning. This happens because of two reasons:
            </p>
            ...
            <ol className="list-decimal list-outside pl-6 space-y-2 mb-4">
                ...
                <li>
                    The assignment is necessary, but the student doesn't understand why. Educators, explain why the 
                    assignment is important, even if it's as simple as: “you'll be tested on this.” Spend more time 
            ...
            <p>
                Students may also use AI on assignments they don't know how to do. This creates a cycle of hurt for the 
            ...
            <ol className="list-decimal list-outside pl-6 space-y-2 mb-4">
                ...
                <li>
                    ...
                    We discussed earlier that students turn to AI when they don't know how to do an assignment. 
            ...
            <p>While thinking of this problem, I'm reminded of a poem by Joseph Fasano:</p>
            ...
            <p>
                ...
                opportunity. The opportunity to be more intentional than we've ever had to be with out learning. 
                Let's get philosophical, shall we? Why do we even care about learning? If the answer to 
                anything you can learn in school is freely available, why prioritize learning things yourself anyway?
            </p>
            
            <p>
                BYU's motto is “enter to learn, go forth to serve.” We do not learn things in school to regurgitate 
            ...
            <p>
                ...
                humanity's problems. It is a marker of human ingenuity, a milestone—a big milestone, yes—in the 
